...
//        }
    ...
    private List<ShopeeProduct> queryDataWithCursor() {
        ...
        lqWrapper.isNotNull(ShopeeProduct::getShopMerchantId);
        lqWrapper.eq(ShopeeProduct::getIsPublish, 1);
        lqWrapper.orderByAsc(ShopeeProduct::getId);
        ...
        try {
            while (true) {
                LambdaQueryWrapper<ShopeeProduct> wrapper = Wrappers.<ShopeeProduct>lambdaQuery()
                        ...
                        .isNotNull(ShopeeProduct::getShopMerchantId)
