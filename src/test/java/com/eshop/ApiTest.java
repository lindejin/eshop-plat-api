...
public class ApiTest {
    ...
    private static final String appKey = "23060081"; // 可替换为您的应用的appKey
    private static final String appSecret = "24977747"; // 可替换为您的应用的appSecret
    private static final String sessionKey = "10969016"; // 必须替换为授权得到的真实有效sessionKey
