...
public  class ShopeeOrderDetailItem {
    ...
    /**
     * Return by default. Long that indicates the date and time that the order was created.
     */
    private Long create_time;

    /**
     * Return by default. Long that indicates the last time that there was a change in value of order, such as order status changed from 'Paid' to 'Completed'.
     */
     ...
     */
    private Long return_request_due_date;
