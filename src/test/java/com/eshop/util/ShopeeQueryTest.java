...
//        }
        ...
        List<CompletableFuture<List<ShopeeOrderDetailRespVO>>> futures = tempList.stream()
                .map(tbOrder -> CompletableFuture.supplyAsync(() -> {
                    try {
                        if (tbOrder.getPlatformId().intValue()!=5){
    ...
    public ShopeeOrderDetailRespVO getOrderDetail(ShopeeAppClientDTO publicDTO, String orderNo) throws Exception {
    ...
    public ShopeeOrderDetailRespVO getOrderDetail(ShopeeAppClientDTO dcDTO, ShopeeOrderDetailReqDTO orderDetailReqDTO) throws Exception {
        ...
        ShopeeOrderDetailRespVO respVO = JSONObject.parseObject(respBody, ShopeeOrderDetailRespVO.class);
        if (respVO == null) {
            respVO = new ShopeeOrderDetailRespVO();
        }
