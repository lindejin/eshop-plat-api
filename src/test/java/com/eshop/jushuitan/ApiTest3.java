...
public class ApiTest3 {
    ...
    private static final String appKey = "35256860"; // 可替换为您的应用的appKey
    private static final String appSecret = "811bc31681a6e83edaa16901666a4603"; // 可替换为您的应用的appSecret
    private static final String sessionKey = ""; // 必须替换为授权得到的真实有效sessionKey
    private static final String targetAppKey = "23060081";
    private static final String customerId = "10969016";
    ...
    private static String getSellerItem() throws IOException {
        ...
        // 公共参数
        params.put("method", "jushuitan.saleout.list.query");
