...
@Getter
@Setter
public class Temu2PurchaseOrderV2VO {
...
类型标识:6，类型:object
     ...
     */
    private Temu2PurchaseOrderV2Result result;
...
类型标识:4，类型:string
    ...
    @Getter
    @Setter
    public static class Temu2PurchaseOrderV2Result {
        /**
         * 说明:总数
是否必填:false
类型标识:1，类型:long
...
类型标识:6，类型:object
         ...
         */
        private Temu2PurchaseOrderV2DeliverInfo deliverInfo;
...
类型标识:6，类型:object
         ...
         */
        private Temu2PurchaseOrderV2SkuQuantityTotalInfo skuQuantityTotalInfo;
...
类型标识:6，类型:object
         ...
         */
        private Temu2PurchaseOrderV2ProcessTypeVO processTypeVO;
...
类型标识:1，类型:long
    ...
    @Getter
    @Setter
    public static class Temu2PurchaseOrderV2ProcessTypeVO {
        /**
         * 说明:工艺类型名称
是否必填:false
类型标识:4，类型:string
...
类型标识:8，类型:list
    ...
    @Getter
    @Setter
    public static class Temu2PurchaseOrderV2DeliverInfo {
        /**
         * 说明:收货时间（单位：毫秒）
是否必填:false
类型标识:1，类型:long
...
类型标识:4，类型:string
    ...
    @Getter
    @Setter
    public static class Temu2PurchaseOrderV2SkuQuantityTotalInfo {
        /**
         * 说明:货币类型(参考 ISO 4217)  CNY-人民币 USD-美元
是否必填:false
类型标识:4，类型:string
...
类型标识:6，类型:object
         ...
         */
        private Temu2PurchaseOrderV2SkuQuantityTotalInfoProcessTypeVO processTypeVO;
...
类型标识:1，类型:long
    ...
    @Getter
    @Setter
    public static class Temu2PurchaseOrderV2SkuQuantityTotalInfoProcessTypeVO {
        /**
         * 说明:工艺类型名称
是否必填:false
类型标识:4，类型:string
