...
public class CombinationAnnotationElementNew implements AnnotatedElement, Serializable {
     ...
     * @since 5.8.0
     */
    public static CombinationAnnotationElementNew of(AnnotatedElement element, Predicate<Annotation> predicate) {
        return new CombinationAnnotationElementNew(element, predicate);
    }
     ...
     * @param element 需要解析注解的元素：可以是Class、Method、Field、Constructor、ReflectPermission
     */
    public CombinationAnnotationElementNew(AnnotatedElement element) {
        this(element, null);
    }
     ...
     * @since 5.8.0
     */
    public CombinationAnnotationElementNew(AnnotatedElement element, Predicate<Annotation> predicate) {
