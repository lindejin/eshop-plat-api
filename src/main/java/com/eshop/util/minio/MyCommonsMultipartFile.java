...
public class MyCommonsMultipartFile implements MultipartFile, Serializable {

    protected static final Log logger = LogFactory.getLog(MyCommonsMultipartFile.class);
     ...
     */
    public MyCommonsMultipartFile(FileItem fileItem) {
     ...
     * path information in {@link WmsCommonsMultipartFile#getOriginalFilename()}.
