...
public class TemuUtils {
    ...
    public static String getSignKey(String appKey, String appSecret, String accessToken, long timestamp, String type, String dataType, JSONObject jsonParams) {
        ...
        String paramsStr = "";
        for (String param : params) {
            paramsStr += param+keyMap.get(param);
        }
        // 在该长串的头部及尾部分别拼接app_secret ，完成签名字符串的组装
        paramsStr = appSecret + paramsStr + appSecret;
        // 对签名字符串，使用MD5 算法加密后，得到的MD5 加密密文后转为大写，即为sign 值
