 ...
 * @description:
 * @author: lindz
 * @create: 2026-01-08 16:49
 **/

@lombok.Getter
@lombok.Setter
public class CainiaoCloudprintCustomaresGetGetRespVO extends BaseResponseVO {
    /**
     * 返回错误信息
     */
     ...
     * 返回授权信息
     */
    private CainiaoCloudprintCustomaresGetResponse cainiao_cloudprint_customares_get_response;
