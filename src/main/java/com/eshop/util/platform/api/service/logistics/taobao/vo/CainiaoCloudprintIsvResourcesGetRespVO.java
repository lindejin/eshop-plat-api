...
@lombok.Getter
@lombok.Setter
public class CainiaoCloudprintIsvResourcesGetRespVO extends BaseResponseVO {
    /**
     * 返回错误信息
     */
     ...
     * 返回授权信息
     */
    private CainiaoCloudprintIsvResourcesGetResponse cainiao_cloudprint_isv_resources_get_response;
}