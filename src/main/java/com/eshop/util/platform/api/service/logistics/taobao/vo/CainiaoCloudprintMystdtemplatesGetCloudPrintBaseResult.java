 ...
 * @description:
 * @author: lindz
 * @create: 2026-01-08 16:38
 **/
@lombok.Getter
@lombok.Setter
public class CainiaoCloudprintMystdtemplatesGetCloudPrintBaseResult {

    //字段名	类型	示例值	说明
    //datas	UserTemplateResult[]	所有cp的数据	数据列表
    //error_code	String	201	错误码
